...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/protego-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9193&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/protego-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `protego` can be installed with:

```
conda install protego
```

It is possible to list all of the versions of `protego` available on your platform with:
